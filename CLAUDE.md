...
Spring Boot starter MCP per Jira Cloud (issues, boards, sprints, comments, users). Maven Central: `io.github.massimilianopili:mcp-jira-tools`.
...
Ricerca semantica: `embeddings_search_docs("mcp-jira-tools")`
